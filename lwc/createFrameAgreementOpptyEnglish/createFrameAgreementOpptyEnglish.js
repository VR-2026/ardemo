...
import { OMNIDEF } from './createFrameAgreementOpptyEnglish_def.js';
import tmpl from './createFrameAgreementOpptyEnglish.html';
import tmpl_nds from './createFrameAgreementOpptyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class createFrameAgreementOpptyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
